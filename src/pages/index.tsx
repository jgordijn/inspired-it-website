    ...
    <Layout title="Jeroen Gordijn" description="AI development advocate, software architect, technical consultant">
      ...
      <section className="py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-sm text-blue-700 dark:text-blue-400 font-semibold uppercase tracking-[0.5em] mb-4">
              My mission
            </p>
      ...
      <section className="py-20">
        <h2 className="text-3xl font-bold text-slate-900 dark:text-gray-100 mb-12">Latest Articles</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {posts.map((post) => (
            <Link
              key={post.slug}
              href={`/blog/${post.slug}`}
              className="block bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden hover:shadow-lg dark:hover:shadow-gray-900/50 transition-shadow cursor-pointer"
            >
