    ...
    >
      <div className="max-w-4xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="space-y-6 mb-8">
              <div className="border-l-4 border-blue-600 pl-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Ahold Delhaize
                  <span className="ml-2 px-2 py-0.5 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 text-xs font-medium rounded">via Inspired IT</span>
          ...
          <div className="bg-blue-50 dark:bg-gray-800 rounded-lg p-6 order-first md:order-last">
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <span className="font-semibold block text-slate-900 dark:text-gray-100">Years of Experience</span>
                <span className="text-gray-600 dark:text-gray-400">20+ years (since 2005)</span>
              </li>
              <li>
                <span className="font-semibold block text-slate-900 dark:text-gray-100">Current Role</span>
                <span className="text-gray-600 dark:text-gray-400">
                  Senior Software Developer &
                  <br />
                  AI Development Advocate
                  <br />
                  <span className="text-blue-600 dark:text-blue-400 font-medium">@</span> Ahold Delhaize
                </span>
              </li>
              <li>
                <span className="font-semibold block text-slate-900 dark:text-gray-100">Primary Languages</span>
                <span className="text-gray-600 dark:text-gray-400">Kotlin, Java</span>
              </li>
              <li>
                <span className="font-semibold block text-slate-900 dark:text-gray-100">Location</span>
                <span className="text-gray-600 dark:text-gray-400">Hilversum, Netherlands</span>
              </li>
              <li>
                <span className="font-semibold block text-slate-900 dark:text-gray-100">Education</span>
                <span className="text-gray-600 dark:text-gray-400">Master's, Software Technology<br />Utrecht University</span>
              </li>
            </ul>
          </div>
        </div>
